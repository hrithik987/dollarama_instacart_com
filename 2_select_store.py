...
params = {
    'operationName': 'HomepagePbiRetailerLocality',
    'variables': '{"retailerIds":["1603"],"postalCode":"K7L4A9","coordinates":{"latitude":44.233359,"longitude":-76.504028},"includeExternalShops":true,"includeAllRetailerLocations":true}',
    'extensions': '{"persistedQuery":{"version":1,"sha256Hash":"580af42310a36f0e6d00bd715dc6132695b0a6a90a96c2d5692c6688f71d7d80"}}',
}
...
for itr in range(1, 11):
    ...
    data = response.json()
    retailerLocationId = _.get(data, 'data.shopCollection.shops[0].retailerLocationId', 'N/A')
    name = _.get(data, 'data.shopCollection.shops[0].retailer.name', 'N/A')
    retailerType = _.get(data, 'data.shopCollection.shops[0].retailer.retailerType', 'N/A')
    print(retailerLocationId)
    print(name)
    print(retailerType)
